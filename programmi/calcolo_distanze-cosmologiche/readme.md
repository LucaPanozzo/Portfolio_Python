...
- Calcolo di distanze cosmologiche in funzione del redshift.
- Calcolo del tempo di lookback.
- Integrazione numerica di funzioni cosmologiche.
...
I calcoli sono basati su un modello cosmologico con costante di Hubble, densità di materia e densità di energia oscura definite dai parametri del modello ΛCDM.
